...
const { getAllBooks, getSingleBookById, allIssuedBooks, addNewBook, updateBookById, deleteBookById } = require('../controllers/book-controller');
...
router.get('/issued/user-name', allIssuedBooks);
